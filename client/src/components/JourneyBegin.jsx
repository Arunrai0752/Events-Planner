...
const JourneyBegin = () => {
  return (
    <>
      <main className=" w-screen h-auto pb-40 bg-pink-100  flex justify-center items-center grid  ">
        <div className="w-[85vw] py-10 bg-white relative bottom-18 left-[7.5%]">
          <div className=" text-center">
            ...
            <h1 className="text-5xl p-2">Your Journey Begins Here</h1>
            <p className="text-2xl p-3">
              Fusce ac condimentum turpis. Ut consequat lacinia augue, vitae
              aliquam sapien <br /> ullamcorper at. Donec efficitur, ligula ut
              lacinia viverra, lorem lacus condimentum <br /> leo, eu luctus
              dolor ex at quam.
            </p>
          </div>
        ...
        <div className="flex w-[85%] relative left-[7.5%]  ">
          <div className="w-[50%] grid gap-7 ">
            <h1 className="text-7xl leading-19 pe-10 ">
              What Our Clients Are Saying
            </h1>
            <p className="text-2xl leading-11  ">
              Fusce ac condimentum turpis. Ut consequat lacinia augue, vitae
          ...
          <div className="w-[85%] flex ">
            ...
            <div className="bg-pink-500 w-[65%] h-[112%] text-white text-4xl  px-30 font-bold  ] ">
             <p className="relative right-9 top-15 z-50"> Choose a life partner not because you can merely live with them,
              but because you cannot imagine living without them</p>
              <br />
              <br />
