...
const JourneyBegin = () => {
  return (
    <>
      <main className="w-screen h-auto pb-40 bg-base-200 justify-center items-center grid">
        <div className="w-[85vw] py-10 bg-base-100 relative bottom-18 left-[7.5%]">
          <div className="text-center">
            <p className="text-6xl flex justify-center p-10 text-primary">
              <FaHeart />
            </p>
            <h1 className="text-5xl text-secondary p-2">
              "Where Two Paths Become One"
            </h1>
            <p className="text-2xl text-base-content p-3">
        ...
        <div className="flex w-[85%] relative left-[7.5%]">
          <div className="w-[50%] grid gap-7">
            <h1 className="text-7xl leading-19 text-accent pe-10">
              What Our Clients Are Saying
            </h1>
            <p className="text-2xl text-secondary leading-11">
            ...
            <Link to="/">
              <h1 className="text-primary hover:text-accent">
                Read More -{">"}
              </h1>
            </Link>
          </div>
          ...
          <div className="w-[85%] flex">
            ...
            <div className="bg-accent w-[65%] h-[112%] text-accent-content text-4xl px-30 font-bold">
              <p className="relative right-9 top-15">
                Choose a life partner not because you can merely live with them,
                but because you cannot imagine living without them
              </p>
              <br />
              <br />
              <h1 className="relative top-10 z-50 signature text-base-content">
                Arun
              </h1>
            </div>
          </div>
