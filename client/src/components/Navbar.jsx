    ...
    <nav className="bg-transparent absolute top-0 left-0 w-full z-10 p-4 " >
      <div className="h-[15vh] w-full bg-transparent flex justify-center items-center">
        <ul className="flex w-[75vw] justify-around bg-transparent gap-4 list-none items-center font-bold text-white">
          ...
          <li><Link to="/morepages" className=" text-amber-400 hover:text-gray-300">MORE PAGES</Link></li>
          <li className="bg-[url(logo.png)] h-[150px] w-[150px] grid bg-cover bg-center " >
            ...
            <FaHeart />
              ...
              <h1 className="text-2xl font-bold text-center  text-black ">Two Souls</h1>
              <span className="block text-center text-black text-1xl">One Promise</span>
            </Link>
          </li>
          ...
          <li><Link to="/elements" className="hover:text-gray-300  text-amber-400 ">ELEMENTS</Link></li>
